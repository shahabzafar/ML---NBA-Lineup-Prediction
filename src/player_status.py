...
class PlayerStatusTracker:
    ...
    def extract_from_matchups(self, data_dir):
        ...
        player_seasons = {}  # Player → seasons played
        player_teams = {}    # Player → teams played for
        start_time = time.time()
        
        # Process each matchup file (each season)
        for year in range(2007, 2016):
            ...
            try:
                # Read only the columns we need to improve performance
                    ...
                    for i in range(5):
                        ...
                        if home_col in chunk.columns:
                            ...
                            for player in home_players:
                                ...
                                # Add team affiliations - more efficient with vectorized operations
    ...
    def is_player_eligible(self, player: str, season: int, game_time: float = 0) -> bool:
        ...
        # If player not in our database, assume eligible
        ...
        # Check if player was active in this season
